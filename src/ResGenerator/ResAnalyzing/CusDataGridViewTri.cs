...
{
    public partial class CusDataGridViewTri : UserControl
    {
        ...
        public int Add(ItemInfo item)
        {
            ...
            return dgvInfo.Rows.Add(upgrade.ToString(), item.Name, item.Value);
        }             
       ...
       {         
        ...
        {
            return ChangeValue(new ItemInfo(name, value));
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            dgvInfo.Columns[0].Width = (dgvInfo.Width - dgvInfo.RowHeadersWidth) / 5;
            dgvInfo.Columns[1].Width = 2*((dgvInfo.Width - dgvInfo.RowHeadersWidth) / 5);
            dgvInfo.Columns[2].Width = 2*((dgvInfo.Width - dgvInfo.RowHeadersWidth) / 5);
            base.OnPaint(e);
        }
        #endregion
