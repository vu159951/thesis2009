...
namespace GameDemo1
{
    ...
    public class MainGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            player1.Units.Add(new ProducerUnit(this, Config.PATH_TO_UNIT_XML + "Unicorn.xml", new Vector2(2900, 2100), 1));
            this._managerGame.ListUnitOnMap.Add(player1.Units[6]);
            ...
            player2.Structures.Add(new Structure(this, Config.PATH_TO_STRUCTURE_XML + "TownHall.xml", new Vector2(4000, 1500), 2));
            ...
            this._managerPlayer.PlayerIsUser = player1;// choose player is user
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            // click mouse
            this._managerPlayer.MousePressedOnMap();
            this._managerPlayer.MouseUpOnMap();
